# Using Skills for Agents with Cursor
...
cp /path/to/Skills for Agents/skills/test-driven-development/SKILL.md .cursor/rules/test-driven-development.md
cp /path/to/Skills for Agents/skills/code-review-and-quality/SKILL.md .cursor/rules/code-review-and-quality.md
cp /path/to/Skills for Agents/skills/incremental-implementation/SKILL.md .cursor/rules/incremental-implementation.md
```
...
cat /path/to/Skills for Agents/skills/test-driven-development/SKILL.md > .cursorrules
echo "\n---\n" >> .cursorrules
cat /path/to/Skills for Agents/skills/code-review-and-quality/SKILL.md >> .cursorrules
```
...
1. `test-driven-development.md` ΓÇö TDD workflow and Prove-It pattern
2. `code-review-and-quality.md` ΓÇö Five-axis review
3. `incremental-implementation.md` ΓÇö Build in small verifiable slices

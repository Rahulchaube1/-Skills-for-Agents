...
This guide explains how to use Skills for Agents with OpenCode in a way that closely mirrors the Claude Code experience (automatic skill selection, lifecycle-driven workflows, and strict process enforcement).
...
- "build a feature" â†’ `incremental-implementation` + `test-driven-development`
- "design a system" â†’ `spec-driven-development`
- "fix a bug" â†’ `debugging-and-error-recovery`
- "review this code" â†’ `code-review-and-quality`
...
- Reproduces â†’ localizes â†’ fixes â†’ adds guards

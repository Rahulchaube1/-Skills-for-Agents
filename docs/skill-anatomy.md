...
This document describes the structure and format of Skills for Agents skill files. Use this as a guide when contributing new skills or understanding existing ones.
...
### Core Process
The heart of the skill. This is the step-by-step workflow the agent follows. Must be specific and actionable â€” not vague advice.
...
Think of every time an agent has said "I'll add tests later" or "This is simple enough to skip the spec" â€” those go here with a factual counter-argument.
...
Don't duplicate content between skills â€” reference and link instead.

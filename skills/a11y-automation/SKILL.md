...
description: Automates accessibility checks and regressions. Use when you need fast, repeatable checks for keyboard, semantic, and contrast issues.
---
> [!NOTE]
...
## Overview
Accessibility Automation is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the accessibility automation workflow.

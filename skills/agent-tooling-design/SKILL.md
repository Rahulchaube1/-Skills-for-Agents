---
name: agent-tooling-design
description: Designs tools, functions, and affordances for agent workflows. Use when you need to expose actions to an AI agent or simplify how it interacts with a system.
---
> [!NOTE]
...
>
> Make agent actions safe and usable.
>
...
## Overview
Agent Tooling Design is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the agent tooling design workflow.

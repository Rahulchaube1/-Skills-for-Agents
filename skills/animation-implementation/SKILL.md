...
description: Adds motion that clarifies, guides, or delights. Use when UI needs transitions, staging, or animated feedback without becoming distracting.
---
> [!NOTE]
...
## Overview
Animation Implementation is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the animation implementation workflow.

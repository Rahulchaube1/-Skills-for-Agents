---
name: api-versioning
description: Plans compatible API evolution across consumers and releases. Use when contracts need to change without breaking clients.
---
> [!NOTE]
...
## Overview
API Versioning is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the api versioning workflow.

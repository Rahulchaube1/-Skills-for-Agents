...
description: Automates browser flows for validation and repetitive tasks. Use when runtime behavior must be confirmed in a real browser.
---
> [!NOTE]
...
> Browser Automation
>
> Verify user-facing behavior in-browser.
>
...
## Overview
Browser Automation is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the browser automation workflow.

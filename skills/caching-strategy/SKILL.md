...
description: Chooses cache layers, expiry rules, and invalidation patterns. Use when performance or cost depends on reducing repeated work.
---
> [!NOTE]
...
## Overview
Caching Strategy is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the caching strategy workflow.

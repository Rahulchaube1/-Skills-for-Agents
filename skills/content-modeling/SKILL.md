...
description: Defines content shapes and schemas for products, docs, or CMS systems. Use when content needs structure before implementation.
---
> [!NOTE]
...
> Content Modeling
>
> Design fields and relationships first.
>
...
## Overview
Content Modeling is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the content modeling workflow.

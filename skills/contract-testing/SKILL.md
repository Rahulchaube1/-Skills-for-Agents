...
description: Checks provider and consumer expectations at boundaries. Use when services or tools depend on stable interfaces.
---
> [!NOTE]
...
> Contract Testing
>
> Lock down interface expectations.
>
...
## Overview
Contract Testing is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the contract testing workflow.

...
description: Shapes information-dense dashboards for clarity and actionability. Use when metrics, trends, or status views need a strong visual hierarchy.
---
> [!NOTE]
...
## Overview
Dashboard Design is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the dashboard design workflow.

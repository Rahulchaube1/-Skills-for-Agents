...
description: Chooses charts and encodings that communicate the right story. Use when raw tables are not enough to explain trends or comparisons.
---
> [!NOTE]
...
## Overview
Data Visualization is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the data visualization workflow.

...
description: Controls package growth, updates, and risk. Use when dependency sprawl, version drift, or supply-chain risk needs attention.
---
> [!NOTE]
...
## Overview
Dependency Hygiene is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the dependency hygiene workflow.

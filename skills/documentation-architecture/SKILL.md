...
description: Structures docs so people and agents can find the right information fast. Use when a documentation set needs hierarchy, navigation, and consistency.
---
> [!NOTE]
...
>
> Create a doc system that scales.
>
...
## Overview
Documentation Architecture is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the documentation architecture workflow.

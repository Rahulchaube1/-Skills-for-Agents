---
name: edge-rendering
description: Designs rendering and data-fetch patterns for edge environments. Use when latency, locality, or distributed execution matters.
---
> [!NOTE]
...
## Overview
Edge Rendering is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the edge rendering workflow.

...
description: Guides detection, triage, mitigation, and follow-up during incidents. Use when production systems are degraded or failing.
---
> [!NOTE]
...
> Incident Response
>
> Stabilize incidents with discipline.
>
...
## Overview
Incident Response is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the incident response workflow.

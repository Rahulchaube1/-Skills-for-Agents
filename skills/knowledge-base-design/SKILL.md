...
description: Shapes internal knowledge systems for discoverability and upkeep. Use when you need a maintainable source of truth for procedures or patterns.
---
> [!NOTE]
...
>
> Organize shared knowledge clearly.
>
...
## Overview
Knowledge Base Design is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the knowledge base design workflow.

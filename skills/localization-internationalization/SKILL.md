...
description: Plans content, UI, and code for multiple languages and regions. Use when products need translation, locale-sensitive formatting, or cultural adaptation.
---
> [!NOTE]
...
>
> Prepare software for global use.
>
...
## Overview
Localization and Internationalization is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the localization and internationalization workflow.

...
description: Reviews translated content for fit, correctness, and tone. Use when localized experiences need human-quality checks.
---
> [!NOTE]
...
## Overview
Localization Review is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the localization review workflow.

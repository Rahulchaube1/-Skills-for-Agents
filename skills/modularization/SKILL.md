---
name: modularization
description: Breaks large systems into focused modules with clear boundaries. Use when code grows too coupled or too hard to own.
---
> [!NOTE]
...
> Modularization
>
> Reduce coupling and improve ownership.
>
...
## Overview
Modularization is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the modularization workflow.

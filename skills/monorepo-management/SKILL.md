...
description: Organizes a multi-package repository for scale and clarity. Use when many packages, apps, or shared libraries must evolve together.
---
> [!NOTE]
...
## Overview
Monorepo Management is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the monorepo management workflow.

...
description: Designs first-run and setup experiences that reduce friction. Use when a product needs clearer activation or guided setup.
---
> [!NOTE]
...
## Overview
Onboarding Flows is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the onboarding flows workflow.

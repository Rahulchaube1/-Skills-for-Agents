...
description: Sets measurable ceilings for speed, size, and cost. Use when performance needs to stay within agreed limits.
---
> [!NOTE]
...
## Overview
Performance Budgeting is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the performance budgeting workflow.

...
description: Shapes prompt systems for reliability and reuse. Use when you need to standardize instructions, system prompts, or agent behavior across tasks.
---
> [!NOTE]
...
## Overview
Prompt Architecture is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the prompt architecture workflow.

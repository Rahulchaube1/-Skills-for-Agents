...
description: Writes release notes that are clear, customer-friendly, and useful. Use when shipping needs a concise summary of changes and impact.
---
> [!NOTE]
...
>
> Translate change into release language.
>
...
## Overview
Release Notes Writing is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the release notes writing workflow.

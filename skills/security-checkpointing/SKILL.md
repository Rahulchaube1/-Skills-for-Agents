---
name: security-checkpointing
description: Adds lightweight security gates throughout development. Use when security review should happen before risky changes proceed.
---
> [!NOTE]
...
>
> Insert security gates into workflow.
>
...
## Overview
Security Checkpointing is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the security checkpointing workflow.

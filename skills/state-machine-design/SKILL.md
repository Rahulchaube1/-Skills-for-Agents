...
description: Models complex behavior as explicit states and transitions. Use when logic becomes ambiguous, branchy, or difficult to reason about.
---
> [!NOTE]
...
## Overview
State Machine Design is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the state machine design workflow.

...
description: Writes clear technical docs, guides, and references. Use when content must explain systems, usage, or decisions to humans and agents.
---
> [!NOTE]
...
## Overview
Technical Writing is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the technical writing workflow.

...
description: Defines logs, metrics, traces, and alerts that matter. Use when systems need better visibility into behavior and failure modes.
---
> [!NOTE]
...
>
> Instrument the system so it can be understood.
>
...
## Overview
Telemetry and Observability is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the telemetry and observability workflow.

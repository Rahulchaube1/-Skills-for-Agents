...
description: Turns research notes into actionable product decisions. Use when interviews, feedback, or observations need to become direction.
---
> [!NOTE]
...
>
> Convert research into product truth.
>
...
## Overview
User Research Synthesis is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the user research synthesis workflow.

...
description: Protects visual consistency with screenshot and DOM-based checks. Use when interface changes could accidentally alter layout or styling.
---
> [!NOTE]
...
## Overview
Visual Regression is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the visual regression workflow.

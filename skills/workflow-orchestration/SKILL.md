...
description: Coordinates multi-step agent workflows and handoffs. Use when tasks span multiple phases, tools, or specialized skills.
---
> [!NOTE]
...
>
> Route work through the right steps.
>
...
## Overview
Workflow Orchestration is a focused workflow for handling this class of work with more clarity and less rework.

## When to Use
- The task fits the workflow orchestration workflow.
